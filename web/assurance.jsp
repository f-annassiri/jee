    ...
    <div class="col-md-8 order-md-1">
      ...
      <ul class="list-group mb-3">
        ...
        <div class="d-block my-3">
          ...
          <div class="custom-control custom-radio">
            <input id="debit" name="paymentMethod" type="radio" value="éspeces"  class="custom-control-input" required>
            <label class="custom-control-label" for="debit">Par éspeces <div class="custom-control custom-radio">
          </div>
        </div>
